...
{
    private $statisticsConfigRepository;
    private $groupsConfigRepository;
    ...
    public function __construct(
        EntityRepositoryInterface $statisticsConfigRepository,
        EntityRepositoryInterface $groupsConfigRepository
    )
    {
        $this->statisticsConfigRepository = $statisticsConfigRepository;
        $this->groupsConfigRepository = $groupsConfigRepository;
    }
     ...
     * @return array
     */
    public function createGroup($data, $context)
    {
        $success = false;
     ...
     * @return array
     */
    public function createStatistic($data, $context)
    {
        $success = false;
     ...
     * @return array
     */
    public function createGroupWithStatistics($context, $groupData = [], $statisticsData = [])
    {
        $success = false;
     ...
     * @param Context $context
     */
    public function removeStatisticsAndGroups($plugin, $context)
    {
        if (empty($plugin))
        {
            return;
