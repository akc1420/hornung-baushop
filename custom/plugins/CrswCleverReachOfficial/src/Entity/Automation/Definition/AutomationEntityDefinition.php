...
namespace Crsw\CleverReachOfficial\Entity\Automation\Definition;

use Crsw\CleverReachOfficial\Entity\Automation\AutomationEntity;
use Crsw\CleverReachOfficial\Entity\Automation\Collection\AutomationEntityCollection;
...
/**
 * Class AutomationEntityDefinition
 *
 * @package Crsw\CleverReachOfficial\Entity\Automation\Definition
 */
class AutomationEntityDefinition extends EntityDefinition
{
    public const ENTITY_NAME = 'cleverreach_automation_entity';
    ...
    {
        return AutomationEntityCollection::class;
    }
