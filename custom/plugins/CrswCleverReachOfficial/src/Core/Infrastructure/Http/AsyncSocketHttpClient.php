 ...
 *
 * @package Crsw\CleverReachOfficial\Core\Infrastructure\Http
 */
class AsyncSocketHttpClient extends CurlHttpClient
{
     ...
     *
     * @throws \Crsw\CleverReachOfficial\Core\Infrastructure\Http\Exceptions\HttpRequestException Thrown when the request
