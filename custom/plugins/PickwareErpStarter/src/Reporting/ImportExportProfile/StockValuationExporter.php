...
class StockValuationExporter implements Exporter, FileExporter, HeaderExporter
{
    ...
    public function getFileName(string $exportId, Context $context): string
    {
        ...
        return sprintf(
            $this->translator->translate('pickware-erp-starter.stock-valuation-export.file-name'),
