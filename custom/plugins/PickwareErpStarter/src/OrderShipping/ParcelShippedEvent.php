...
class ParcelShippedEvent
{
    ...
    private bool $isPartiallyDelivery;
    ...
    public function isPartiallyDelivery(): bool
    {
        return $this->isPartiallyDelivery;
    }
