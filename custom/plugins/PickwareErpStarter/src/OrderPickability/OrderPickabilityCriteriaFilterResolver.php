...
class OrderPickabilityCriteriaFilterResolver
{
     ...
     *
     * @param Filter[] $filters
     * @return array|null A tuple of the pickability filter's valid warehouse IDs and pickability status, if set.
     *         Otherwise null.
     */
    private static function removePickabilityFilterComponents(array &$filters): ?array
    {
        ...
        return [
            (is_array($pickabilityWarehouseIdFilter->getValue())) ? $pickabilityWarehouseIdFilter->getValue() : [$pickabilityWarehouseIdFilter->getValue()],
