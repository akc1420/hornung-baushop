...
class ProductSupplierConfigurationExporter implements Exporter, FileExporter, HeaderExporter
{
    ...
    public function getFileName(string $exportId, Context $context): string
    {
        ...
        return sprintf(
            $this->translator->translate('pickware-erp-starter.product-supplier-configuration-export.file-name'),
