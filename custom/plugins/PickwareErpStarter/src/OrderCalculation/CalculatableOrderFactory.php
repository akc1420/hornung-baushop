...
class CalculatableOrderFactory
{
    ...
    /**
     * Returns a CalculatableOrder for each ReturnOrder of the given Order. ReturnOrders that are not approved yet are
     * filtered (see self::RETURN_ORDER_STATE_IGNORE_LIST).
     *
