...
class ImportExportSchedulerMessageHandler
{
    ...
    private ImportExportWriterRegistry $importExportWriterRegistry;
    ...
    public function __construct(
        ...
        ImportExportWriterRegistry $importExportWriterRegistry,
        ...
        $this->importExportWriterRegistry = $importExportWriterRegistry;
    ...
    public function handleWriteDatabaseToFileMessage(ImportExportSchedulerMessage $message): ?ImportExportSchedulerMessage
    {
        $export = $this->getImportExportFromMessage($message);
