...
class OrderDocumentService
{
    ...
    public function createDocumentWithTechnicalName(
        ...
        $this->renderDocument($documentIdStruct->getId(), $context);
    ...
    private function renderDocument(string $documentId, Context $context): void
    {
        // A document is rendered, when it is fetched the first time.
        ...
        $this->documentService->getDocument($document, $context);
    }
}
