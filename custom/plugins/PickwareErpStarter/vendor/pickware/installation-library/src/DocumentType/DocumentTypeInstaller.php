...
class DocumentTypeInstaller
{
     ...
     */
    public function installDocumentType(DocumentType $documentType, ?Context $context = null): void
    {
        if (!$context) {
            trigger_error(
        ...
        if ($this->entityManager) {
            $this->installDocumentTypeWithEntityManager($documentType, $context);
    ...
    private function installDocumentTypeWithEntityManager(DocumentType $documentType, $context): void
    {
        $this->entityManager->runInTransactionWithRetry(function () use ($documentType, $context): void {
            $documentTypeId = $this->ensureDocumentTypeExistsWithEntityManager($documentType, $context);
            $this->ensureGlobalDocumentBaseConfigExistsWithEntityManager($documentType, $documentTypeId, $context);
        });
    }

    private function ensureDocumentTypeExistsWithEntityManager(
