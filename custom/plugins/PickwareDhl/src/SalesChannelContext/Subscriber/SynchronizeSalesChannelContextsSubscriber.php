...
namespace Pickware\PickwareDhl\SalesChannelContext\Subscriber;
...
class SynchronizeSalesChannelContextsSubscriber implements EventSubscriberInterface
{
    ...
    public function onSalesChannelContextSwitched(SalesChannelContextSwitchEvent $event): void
    {
        ...
        $existingPickwareSalesChannelContext = $this->entityManager->findOneBy(
        ...
        $this->entityManager->upsert(
            ...
            [[
                ...
                'payload' => array_replace_recursive(
                    $existingPickwareSalesChannelContext ? $existingPickwareSalesChannelContext->getPayload() : [],
                    $pickwarePayload,
                ),
            ],
            ],
