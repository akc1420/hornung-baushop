...
class MailTemplateInstaller
{
    ...
    public function installMailTemplate(
        ...
        if ($this->entityManager) {
            ...
            $this->installMailTemplateTypeWithEntityManager($mailTemplate, $logger, $context);
    ...
    private function installMailTemplateTypeWithEntityManager(
        ...
        $this->entityManager->runInTransactionWithRetry(function () use ($mailTemplate, $logger, $context): void {
            $mailTemplateTypeId = $this->ensureMailTemplateTypeWithEntityManager($mailTemplate, $context);
            $mailTemplateId = $this->ensureMailTemplateWithEntityManager($mailTemplate, $mailTemplateTypeId, $context);
