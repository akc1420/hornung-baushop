...
class NumberRangeInstaller
{
     ...
     */
    public function ensureNumberRange(NumberRange $numberRange, ?Context $context = null): void
    {
        if (!$context) {
            trigger_error(
        ...
        if ($this->entityManager) {
            $this->ensureNumberRangeWithEntityManager($numberRange, $context);
    ...
    private function ensureNumberRangeWithEntityManager(NumberRange $numberRange, Context $context): void
    {
