...
class EntityManager
{
    ...
    public function __construct(
        ...
        ?EntityDefinitionQueryHelper $entityDefinitionQueryHelper = null
    ) {
        ...
        /**
         * @deprecated tag:next-major EntityDefinitionQueryHelper is optional to keep the constructor backwards
         * compatible. Will be non-optional with the next major release.
         */
        if ($entityDefinitionQueryHelper instanceof EntityDefinitionQueryHelper) {
    ...
    public function lockPessimistically(string $entityDefinitionClassName, $criteria, Context $context): array
    {
        ...
        // do this ourselves.
        // See https://github.com/shopware/platform/blob/2bf9456550ea99b4ecb4a9a19969dec635b20da7/src/Core/Framework/DataAbstractionLayer/Dbal/EntitySearcher.php#L210-L214.
        ...
        // See https://github.com/shopware/platform/blob/2bf9456550ea99b4ecb4a9a19969dec635b20da7/src/Core/Framework/DataAbstractionLayer/Dbal/EntitySearcher.php#L86-L98.
        ...
        return $this->db->fetchFirstColumn($sql, $queryBuilder->getParameters(), $queryBuilder->getParameterTypes());
    }
