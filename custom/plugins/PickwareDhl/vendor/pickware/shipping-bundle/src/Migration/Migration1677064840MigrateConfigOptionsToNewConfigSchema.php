...
class Migration1677064840MigrateConfigOptionsToNewConfigSchema extends MigrationStep
{
    ...
    public function update(Connection $connection): void
    {
        ...
        $connection->executeStatement(
            ...
            SET
                `shipment_config_default_values` = JSON_EXTRACT(`config_default_values`, "$.shipmentConfig"),
                `shipment_config_options` = JSON_EXTRACT(`config_options`, "$.shipmentConfig"),
                `storefront_config_default_values` = JSON_EXTRACT(`config_default_values`, "$.storefrontConfig"),
                `storefront_config_options` = JSON_EXTRACT(`config_options`, "$.storefrontConfig")',
        );
