...
class DeliveryNotePaypalDocumentGenerator implements DocumentGeneratorInterface
{
    public const DEFAULT_TEMPLATE = '@Hornung/documents/delivery_note_paypal.html.twig';
    public const DOCUMENT_TYPE_TECHNICAL_NAME = 'delivery_note_paypal';
    public const DOCUMENT_FILE_PREFIX = 'delivery_note_paypal_';
